...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Heure d'arrivée le <?php echo $date?></h1>
			</div>
		</div><!--/.row-->
                            ...
                            <ul class="timeline">   
                                <?php     
                                    ...
                                    if($_SESSION['id'] != NULL) {
                                        ...
                                        $income_time = substr($dDate, 11,8);
                                        var_dump($income_time);
                                        

                                        /* Pour enregistrer la date actuelle (date/heure/minutes/secondes) on peut utiliser directement la fonction mysql : NOW()*/
                                        $insertion = "INSERT INTO C1HOR_DOT (id, income) VALUES (:id, :income)";

                                        /* préparation de l'insertion */
                                        $insert_prep = $connect->prepare($insertion);

                                        /* Exécution de la requête en passant les marqueurs et leur variables associées dans un tableau*/
                                        $inser_exec = $insert_prep->execute(array(':id'=>$_SESSION['id'], ':income'=>$income_time));
                                    }
                                    ?>
                                <p>
                                    Date : <?php ?>
